...
The script saves two figures in ``examples/plots`` and displays them.  Pass
...
def main(*, show_plots: bool = True, plot_dir: Path = DEFAULT_PLOT_DIR) -> None:
    ...
    # ------------------------------------------------------------------
    # 3. Solve using repeated two-level V-cycles.
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # 4. Make and save the field and diagnostic plots.
    # ------------------------------------------------------------------
